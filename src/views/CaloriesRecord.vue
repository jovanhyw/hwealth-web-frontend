            ...
            <v-row>
              <v-col cols="4">
                <v-card color="#1F7087" dark>
                  <v-card-title class="headline">
                    Date
                    <v-icon class="ml-2">mdi-calendar</v-icon></v-card-title
                  >
                  <v-card-subtitle>{{
              ...
              <v-col cols="4">
                <v-card color="#385F73" dark>
                  <v-card-title class="headline"
                    >Meal Type
                    <v-icon class="ml-2">mdi-food</v-icon></v-card-title
                  >
              ...
              <v-col cols="4">
                <v-card color="#922175" dark>
                  <v-card-title class="headline"
                    >Total Calories
                    <v-icon class="ml-2">mdi-hospital-box</v-icon></v-card-title
                  >
